...
class Desbalanceo:
    ...
    def balancear_clases_smote_nc(self, lista_categoricas):
        ...
        Parámetros:
        -----------
        categorical_features (list): Lista de índices de las columnas categóricas en el DataFrame.

        Returns:
        --------
        X_resampled, y_resampled: DataFrames con las variables independientes y la variable objetivo balanceados.
        """
